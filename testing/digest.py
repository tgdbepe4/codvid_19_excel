...
field_names = "date,country,abbreviation_canton,name_canton,lat,long,tests_performed,total_positive_cases,total_hospitalized,intensive_care,intensive_vent,recovered,deaths".split(',')
...
def transform_row(row):
    ...
    new_row['intensive_vent'] = row['ncumul_vent']
    new_row['recovered'] = row['ncumul_released']
    new_row['deaths'] = row['ncumul_deceased']
#    new_row['ncumul_ICF'] = row['ncumul_ICF']
#    new_row['ninst_ICU_intub'] = row['ninst_ICU_intub']
#    new_row['ncumul_deceased_suspect'] = row['ncumul_deceased_suspect']
    return new_row
